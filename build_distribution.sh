...
function exit_with_usage() {
  ...
  echo "Usage:"
  echo "+------------------------------------------------------------------------------------------------------+"
  echo "| ./build_distribution.sh [--spark2-mvn <custom maven options>] [--spark3-mvn <custom maven options>]  |"
...
BUILD_COMMAND_SPARK2=("$MVN" clean package -Pspark2 -pl client-spark/spark2 -DskipTests -am $@ $SPARK2_MVN_OPTS)
...
BUILD_COMMAND_SPARK3=("$MVN" clean package -Pspark3 -pl client-spark/spark3 -DskipTests -am $@ $SPARK3_MVN_OPTS)
