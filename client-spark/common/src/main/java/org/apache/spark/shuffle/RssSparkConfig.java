...
public class RssSparkConfig {
  ...
  public static final String RSS_CLIENT_MAPSIDE_MERGE_SPILL_THRESHOLD =
      SPARK_RSS_CONFIG_PREFIX + "rss.client.mapside.merge.spill.threshold";
  public static final long RSS_CLIENT_MAPSIDE_MERGE_SPILL_THRESHOLD_DEFAULT_VALUE = 128 * 1024 * 1024;
