...
public class LocalFileReplicaReadHandler extends SkippableReadImpl {
  private static final Logger LOG = LoggerFactory.getLogger(
      LocalFileReplicaReadHandler.class);
  private final int partitionNumPerRange;
  private final int partitionNum;
  private ShuffleServerClient shuffleServerClient;

  LocalFileReplicaReadHandler(
      String appId,
      int shuffleId,
      int partitionId,
      int indexReadLimit,
  ...
  @Override
  public ShuffleIndexResult readShuffleIndexImpl() {
  ...
  @Override
  public ShuffleDataResult readShuffleDataImpl(ShuffleDataSegment shuffleDataSegment) {
