...
public class ShuffleReadClientImplTest extends HdfsTestBase {
  ...
  public void readTest1() throws Exception {
    ...
    ShuffleReadClientImpl readClient = new ShuffleReadClientImpl(StorageType.MEMORY_HDFS.name(), "appId", 0, 1, 100, 1,
    ...
    readClient = new ShuffleReadClientImpl(StorageType.MEMORY_HDFS.name(), "appId", 0, 1, 100, 1,
        10, 1000, basePath, blockIdBitmap, taskIdBitmap, Lists.newArrayList(), new Configuration());
    TestUtils.validateResult(readClient, expectedData);
    try {
  ...
  public void readTest7() throws Exception {
    ...
    ShuffleReadClientImpl readClient1 = new ShuffleReadClientImpl(StorageType.MEMORY_HDFS.name(),
        "appId", 0, 0, 100, 2, 10, 100,
        basePath, blockIdBitmap1, taskIdBitmap, Lists.newArrayList(), new Configuration());
    ShuffleReadClientImpl readClient2 = new ShuffleReadClientImpl(StorageType.MEMORY_HDFS.name(),
  ...
  public void readTest11() throws Exception {
    ...
    ShuffleReadClientImpl readClient = new ShuffleReadClientImpl(StorageType.MEMORY_HDFS.name(), "appId", 0, 1, 1, 1,
        10, 1000, basePath, blockIdBitmap, taskIdBitmap, Lists.newArrayList(), new Configuration());
    ...
    readClient = new ShuffleReadClientImpl(StorageType.MEMORY_HDFS.name(), "appId", 0, 1, 2, 1,
        10, 1000, basePath, blockIdBitmap, taskIdBitmap, Lists.newArrayList(), new Configuration());
    ...
    readClient = new ShuffleReadClientImpl(StorageType.MEMORY_HDFS.name(), "appId", 0, 1, 3, 1,
        10, 1000, basePath, blockIdBitmap, taskIdBitmap, Lists.newArrayList(), new Configuration());
    ...
    readClient = new ShuffleReadClientImpl(StorageType.MEMORY_HDFS.name(), "appId", 0, 1, 10, 1,
        10, 1000, basePath, blockIdBitmap, taskIdBitmap, Lists.newArrayList(), new Configuration());
    ...
    readClient = new ShuffleReadClientImpl(StorageType.MEMORY_HDFS.name(), "appId", 0, 1, 11, 1,
        10, 1000, basePath, blockIdBitmap, taskIdBitmap, Lists.newArrayList(), new Configuration());
